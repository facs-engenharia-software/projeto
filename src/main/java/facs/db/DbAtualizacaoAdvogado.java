...
class DbAtualizacaoAdvogado {
    ...
    static void atualizarRegistroDoAdvogado(Advogado advogado, String novoValor, Connection connection) {
        atualizar(advogado.getNumeroRegistro(), novoValor, connection, "UPDATE advogados SET registro_do_advogado = ? WHERE registro_do_advogado = ?");
    }

    static void atualizarNome(Advogado advogado, String novoValor, Connection connection) {
        atualizar(advogado.getNumeroRegistro(), novoValor, connection, "UPDATE advogados SET nome = ? WHERE registro_do_advogado = ?");
    }

    static void atualizarEndereco(Advogado advogado, String novoValor, Connection connection) {
        atualizar(advogado.getNumeroRegistro(), novoValor, connection, "UPDATE advogados SET endereco = ? WHERE registro_do_advogado = ?");
    }
